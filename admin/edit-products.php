...
<?php 
	...
	<div class="controls">
		<input type="text"    name="productCompany"  placeholder="Enter Product Comapny Name" value="<?php echo htmlentities($row['productCost']);?>" class="span8 tip" required>
	</div>
	</div>
...
<?php } ?>
	...
	<div class="control-group">
		<div class="controls">
			<button type="submit" name="submit" class="btns">Update</button>
		</div>
	</div>
