...
<div class="breadcrumb">
	<div class="container">
		<div class="breadcrumb-inner">
			...
			<?php
			$ret=mysqli_query($con,"select category.categoryName as catname,subCategory.subcategory as subcatname,products.productName as pname,size.size as psize from products join category on category.id=products.category join subcategory on subcategory.id=products.subCategory join size on size.id=products.size where products.id='$pid'");
			...
			while ($rw=mysqli_fetch_array($ret))
				{
					...
					<ul class="list-inline list-unstyled">
						...
						<li>size:<?php echo htmlentities($rw['psize']);?></li>
...
<?php } ?>
	<div class="stock-container info-container m-t-10">
			<div class="row">
				...
				<div class="col-sm-9">
					<div class="stock-box">
						<span class="value"><?php echo htmlentities($row['productQty']);?> pcs</span>
					</div>	
				</div>
			</div>	
	</div>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="owl-carousel home-owl-carousel upsell-product custom-carousel owl-theme outer-top-xs">
		...
		<?php 
$qry=mysqli_query($con,"select * from products where subCategory='$subcid' and category='$cid' and size='$size'");
