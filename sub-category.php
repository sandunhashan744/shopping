...
<div class="side-menu animate-dropdown outer-bottom-xs">
    ...
    <div class="head">
    	<i class="icon fa fa-align-justify fa-fw"></i>Select Size
    </div>     

    <nav class="yamm megamenu-horizontal" role="navigation">
        <ul class="nav">
            <li class="dropdown menu-item">
              <?php $sql=mysqli_query($con,"select id,size  from size where subcategory='$cid'");

while($row=mysqli_fetch_array($sql))
{
    ?>
    	<a href="sizepage.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle">
    		<i class="icon fa fa-star fa-fw"></i>
    		<?php echo $row['size'];?>
    	</a>
    <?php }?>
